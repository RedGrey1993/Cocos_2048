System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Label, Node, NodeEventType, Prefab, randomRangeInt, tween, UITransform, Vec3, view, Block, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, gBlockHorizontalNum, gBlockVerticalNum, gRandomGenerateNumbers, gTouchMoveThreshold, Game;
          ...
          var moveFinish = () => {
            ...
            if (cur == toMove.length) {
              if (this.acuallyMoved) {
                ...
                this.addRandomNumberBlock();
              } else if (toMove.length == gBlockHorizontalNum * gBlockVerticalNum && this.checkFail()) {
...
//# sourceMappingURL=347b08c4545d335fc2f4c98e47fa1625f5609847.js.map