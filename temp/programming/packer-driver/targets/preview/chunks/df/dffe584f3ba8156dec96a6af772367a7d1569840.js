    ...
    execute: function () {
      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        addRandomNumberBlock() {
          ...
          var blockUiTransform = block.getComponent(UITransform);
          blockUiTransform.width = blockUiTransform.height = this.blockSize;
          block.setPosition(pos.x, pos.y, 1); // console.log(gRandomGenerateNumbers[randomRangeInt(0, gRandomGenerateNumbers.length)]);
...
//# sourceMappingURL=dffe584f3ba8156dec96a6af772367a7d1569840.js.map