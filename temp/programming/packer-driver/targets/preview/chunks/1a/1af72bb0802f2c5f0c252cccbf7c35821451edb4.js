      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        drawBgBlocks() {
          ...
          for (var i = 0; i < gBlockVerticalNum; ++i) {
            ...
            this.blockPositions.push(new Array(gBlockHorizontalNum, 0));
        ...
        init() {
          ...
          for (var i = 0; i < gBlockVerticalNum; ++i) {
            this.blocks.push(new Array(gBlockHorizontalNum, null));
          }
...
//# sourceMappingURL=1af72bb0802f2c5f0c252cccbf7c35821451edb4.js.map