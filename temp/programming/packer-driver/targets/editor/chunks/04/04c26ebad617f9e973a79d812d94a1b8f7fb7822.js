System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Label, Node, NodeEventType, Prefab, randomRangeInt, tween, UITransform, Vec3, view, Block, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, gBlockHorizontalNum, gBlockVerticalNum, gRandomGenerateNumbers, gTouchMoveThreshold, Game;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'instantiate', 'Label', 'Node', 'NodeEventType', 'Prefab', 'randomRangeInt', 'Sprite', 'tween', 'UITransform', 'Vec2', 'Vec3', 'view']);
        ...
        move(x, y, callback) {
          ...
          if (!this.inRange(tx, ty)) {
            ...
            this.moveAninmation(this.blocks[x][y], pos, () => {
              var num = this.blocks[x][y].getComponent(_crd && Block === void 0 ? (_reportPossibleCrUseOfBlock({
                error: Error()
              }), Block) : Block).getNumber();
              this.blocks[x][y].getComponent(_crd && Block === void 0 ? (_reportPossibleCrUseOfBlock({
                error: Error()
...
//# sourceMappingURL=04c26ebad617f9e973a79d812d94a1b8f7fb7822.js.map