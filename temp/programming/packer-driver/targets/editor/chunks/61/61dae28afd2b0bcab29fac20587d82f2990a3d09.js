System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Label, Node, NodeEventType, Prefab, randomRangeInt, tween, UITransform, Vec2, Vec3, view, Block, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, gBlockHorizontalNum, gBlockVerticalNum, gRandomGenerateNumbers, gTouchMoveThreshold, Game;
          ...
          for (var i = 0; i < gBlockHorizontalNum; ++i) {
            for (var j = 0; j < gBlockVerticalNum; ++j) {
              if (j > 0 && this.blocks[i][j] != null) {
                ...
                t.to(0.5, {
                  worldPosition: new Vec3(this.blockPositions[i][j - 1].x, this.blockPositions[i][j - 1].y, 1)
                }, {
                  easing: 'backOut'
                });
                t.call(() => {});
...
//# sourceMappingURL=61dae28afd2b0bcab29fac20587d82f2990a3d09.js.map