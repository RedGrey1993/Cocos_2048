  ...
  return {
    ...
    execute: function () {
      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        drawBgBlocks() {
          this.blockSize = (view.getVisibleSize().width - this.gap * (this.blockHorizontalNum + 1)) / this.blockHorizontalNum;
          this.blockPositions = [];
...
//# sourceMappingURL=68c013c87ef43f5f2c5d074337ebaba9e4628aac.js.map