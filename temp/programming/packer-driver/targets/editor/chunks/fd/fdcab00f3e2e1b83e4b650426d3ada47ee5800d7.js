System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Label, Node, NodeEventType, Prefab, randomRangeInt, UITransform, Vec2, view, Block, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, gBlockHorizontalNum, gBlockVerticalNum, gRandomGenerateNumbers, Game;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'instantiate', 'Label', 'Node', 'NodeEventType', 'Prefab', 'randomRangeInt', 'Sprite', 'UITransform', 'Vec2', 'view']);
      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        addEventHandler() {
          ...
          this.background.on(NodeEventType.TOUCH_END, event => {
            ...
            console.log(this.endPosition); // var dirVec = Vec2.subtract(this.endPosition - this.startPosition;
            // console.log(dirVec);
          });
        }
...
//# sourceMappingURL=fdcab00f3e2e1b83e4b650426d3ada47ee5800d7.js.map