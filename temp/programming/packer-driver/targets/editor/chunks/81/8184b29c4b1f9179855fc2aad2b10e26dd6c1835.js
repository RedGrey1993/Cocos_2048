    ...
    execute: function () {
      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
          ...
          for (var i = 0; i < gBlockVerticalNum; ++i) {
            ...
            for (var j = 0; j < gBlockHorizontalNum; ++j) {
              ...
              block.getComponent(_crd && Block === void 0 ? (_reportPossibleCrUseOfBlock({
                error: Error()
              }), Block) : Block).setNumber(0); // this.background.addChild(block);
        ...
        addRandomNumberBlock() {
          ...
          this.background.addChild(block); // this.blocks[index[0]][index[1]] = block;
        }
...
//# sourceMappingURL=8184b29c4b1f9179855fc2aad2b10e26dd6c1835.js.map