System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Label, Node, Prefab, Sprite, UITransform, view, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, Game;
    ...
    execute: function () {
      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        start() {
          ...
          var blockSprite = block.getComponent(Sprite); // blockSprite.color = colors[2];
...
//# sourceMappingURL=e8fbde0b4bfe6e818e4496ac703a48ae880e1a21.js.map