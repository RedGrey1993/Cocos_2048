    ...
    execute: function () {
      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        addRandomNumberBlock() {
          ...
          var blockUiTransform = block.getComponent(UITransform);
          blockUiTransform.width = blockUiTransform.height = this.blockSize;
          block.setPosition(pos.x, pos.y, -100); // console.log(gRandomGenerateNumbers[randomRangeInt(0, gRandomGenerateNumbers.length)]);
...
//# sourceMappingURL=46380b398451bb3241e548ffca9df4bd302c7e8e.js.map